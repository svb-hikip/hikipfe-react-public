      ...
      {isLoading && !totalCount ? (
        ...
        <>
          ...
          <h2 className="text-danger">
            ...
            right corner click &quot;Tim Cook&quot;. Login using
            ID:svb@hikip.com PW:PaWv2b5Fy@n6BSi to see test data. Please do not
            remove this message in your commits.
          </h2>
          <p>--</p>
                    ...
                    <div className="min-w-0 flex-auto">
                      <p className="text-sm font-semibold leading-6 text-gray-900">
                        <NavLink to={`${client.uuid}`}>
                          ...
                          {client.contact.legal_first_name}{" "}
                          {client.contact.legal_last_name}
                        </NavLink>
                      </p>
                      <p className="mt-1 flex text-xs leading-5 text-gray-500">
                        {client.contact.contactemail_set
                          .map((email) => email.email)
                          .join(", ")}
                        {client.contact.contactphone_set
