...
import classNames
 from '../layout/dashboardComps/helper';
...
=======
            <dd className="mt-1 text-sm leading-6 text-gray-700 sm:mt-2">{data.contact.legal_first_name} {data.contact.legal_last_name} | {data.client_type} | {data.billing_type}</dd>
>>>>>>> 75131caebb0dcefe775c014f3d42b668cbb0ce9f
          ...
          <div className="border-t border-gray-100 px-4 py-6 sm:col-span-1 sm:px-0">
            ...
            <ul>
                ...
                <li key={index}>
                    {email.email} - Type: {email.type}, Permission to Contact: {email.permission ? 'Granted' : 'Denied'}
                </li>
                ))}
            </ul>
            </dd>
          ...
          <div className="border-t border-gray-100 px-4 py-6 sm:col-span-1 sm:px-0">
            ...
            <ul>
                {data.contact.contactphone_set.map((item, index) => (
                    <li key={index}>
                    {item.phone_number} - Type: {item.type}, Voice: {item.voice ? 'Yes' : 'No'}, Text: {item.text ? 'Yes' : 'No'}
                    </li>
                ))}
            </ul>
            </dd>
