...
export default function Settings() {
  ...
  return (
    <>
      ...
      <div className="mx-auto max-w-7xl pt-3 lg:flex lg:gap-x-3 lg:px-8">
        <h1 className="sr-only">General Settings</h1>
        <aside className="flex overflow-x-auto border-b border-gray-900/5 py-4 lg:block lg:w-64 lg:flex-none lg:border-0 lg:py-3">
        ...
        <main className="px-4 py-16 sm:px-6 lg:flex-auto lg:px-0 lg:py-3">
